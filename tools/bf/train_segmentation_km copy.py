...
parser.add_argument('--tag', default='train_kmeansesp_saientcy_resnest50_withquforq', type=str)
...
if __name__ == '__main__':
    ...
    model = model.cuda()
    model.train()
    # model.load_state_dict(torch.load('experiments/models/train_kmeansesp_saientcy_resnest50_withq_fgmask.pth'))
    ...
    for iteration in range(max_iteration):
        ...
        if(True):
            ...
            q_loss =F.mse_loss(logits,reconstr_feat.cuda(0).detach())
