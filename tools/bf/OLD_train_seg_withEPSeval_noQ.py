...
import random
import argparse
from cv2 import LMEDS, log, threshold
import numpy as np
import datetime
...
from tools.ai.evaluate_utils_copy import *
...
parser.add_argument('--tag', default='baseline_new_eval', type=str)
...
if __name__ == '__main__':
    ...
    for iteration in range(max_iteration):
        ...
        if (iteration + 1) % val_iteration == 0:
            ...
            best_mIoU,re_th=evaluatorA.evaluate(model,'/media/ders/zhangyumin/PuzzleCAM/experiments/models/train_Q_relu.pth')
            ...
            data = {
                ...
                'threshold' : threshold,
                'mIoU' : mIoU*100,
                'best_valid_mIoU' : best_valid_mIoU*100,
